import { cls15, cls16, cls17, cls18, cls19, cls20, cls21, cls22, cls23, cls24, cls25, cls26, cls27 } from "@/components/templates/ux/cls"
      ...
      <li id="account-accordion" className={cls17}>
        <button type="button" className={cls18}>
          ...
          >
            ...
            <path d="M10 15H6a4 4 0 0 0-4 4v2"> </path> <path d="m21.7 16.4-.9-.3"> </path> <path d="m15.2 13.9-.9-.3"> </path>{" "}
            <path d="m16.6 18.7.3-.9"> </path> <path d="m19.1 12.2.3-.9"> </path> <path d="m19.6 18.7-.4-1"> </path> <path d="m16.8 12.3-.4-1"> </path>{" "}
            <path d="m14.3 16.6 1-.4"> </path> <path d="m20.7 13.8 1-.4"> </path>{" "}
          </svg>
          Account
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        ...
        <a href="#" className={cls27}>
          ...
          >
            ...
            <path d="M8 14h.01"> </path> <path d="M12 14h.01"> </path> <path d="M16 14h.01"> </path> <path d="M8 18h.01"> </path> <path d="M12 18h.01"> </path>{" "}
